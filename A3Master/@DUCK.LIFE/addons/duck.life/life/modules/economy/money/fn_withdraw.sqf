...
if (_moneyBank < _amount) exitWith { false; };
...
_tmp01 = [_databaseID, _steamID64, _moneyBank, _schema, "bank"] call DUC_CORE_redis_fnc_listEntryUpdate;
_tmp02 = [_databaseID, _steamID64, _moneyCash, _schema, "cash"] call DUC_CORE_redis_fnc_listEntryUpdate;
