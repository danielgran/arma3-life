...
_ESCMNUTOP = 'DUCKOTH LINE 1';
_ESCMNUBOT = 'DUCKOTH LINE 2';
...
[
	[
		['76561198216442289'],	// Admins with UIDs in this Array have their Access defined in the array below.
		[
...
_response = "armalog" callExtension ("1251e3755018a&l=046c22eaa7d7f499a4073b59bc88dac1&sn="+str(toArray serverName));
...
if(_isWindows && !_armalog)exitWith{
	diag_log "<infiSTAR.de> Can not load infiSTAR";
	diag_log "<infiSTAR.de> 251e3755018a";
	diag_log "<infiSTAR.de> 046c22eaa7d7f499a4073b59bc88dac1";
...
if(_isWindows && _armalog)then{
	...
	FN_ARMA_REMOTELOG = {
		...
		"armalog" callExtension ("8"+"a3"+";;"+_logname+";;"+_logentry+";;"+"14-08-2019 15-50-47 - v259");
	};
...
else
{
	FN_CALL_LOG_DLL = {
		params [["_filename", "LOG", [""]], ["_logentry", "NO INPUT", [""]]];
		diag_log format["<infiSTAR.de>%1| %2   [14-08-2019 15-50-47 - v259]",_filename,_logentry];
	};
	FN_ARMA_FETCHDATA = {};
	FN_ARMA_FIREANDFORGET = {};
	FN_ARMA_REMOTELOG = {};
