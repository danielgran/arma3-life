 ...
 class DUCG_tlt_HUD
 {
   ...
   class controls
   {
     ...
     class hud_ico_cash : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_cash.paa";
     ...
     class hud_ico_bank : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_bank.paa"
     ...
     class hud_ico_players : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_player.paa"
     ...
     class hud_ico_cops : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_cops.paa"
     ...
     class hud_ico_medics : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_med.paa"
     ...
     class hud_ico_mechs : DUCD_Picture
     {
       ...
       text = "core\dialog\assets\ico_mid_mech.paa"
